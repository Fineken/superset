...
"SERIES_COLORS": True,
"DASHBOARD_CROSS_FILTERS": True,   # Включает возможность кросс-фильтрации
"DASHBOARD_EDIT_MODE": True,       # Включает режим редактирования дашбордов
"ENABLE_TEMPLATE_PROCESSING": True,
...
SUPERSET_WEBSERVER_TIMEOUT = 1200
DASHBOARD_RBAC = True # Запрос от Николая 
HTML_SANITIZATION = False
ENABLE_RBAC = True
TALISMAN_ENABLED = False
